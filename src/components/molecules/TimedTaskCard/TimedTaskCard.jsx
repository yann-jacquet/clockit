...
const TimedTaskCard = ({ isNonIdTask, children, onLinkIDClick }) => (
  <li className={`
  ...
  >
    ...
    <button
      className={`
        timed-task-card-link-btn absolute right-0 bg-blue-300 hover:bg-blue-500 text-white font-bold py-1 px-2 rounded rounded-r-none shadow-md focus:outline-none focus:shadow-outline border-b-4 border-blue-500 hover:border-blue-300
      `}
      type="button"
